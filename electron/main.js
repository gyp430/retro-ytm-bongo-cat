...
// bongo-cat app icon (generated by build/make-icon.py). renderer/ is bundled
// into app.asar, so this path resolves in both dev and the packaged build; the
// portable .exe's own icon comes from build/icon.ico via electron-builder.
